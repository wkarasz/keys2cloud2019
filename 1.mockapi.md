...
1)	Navigate to **passengers**, hover over passengers in the API spec list, select <span style="font-weight:bold; font-size:12;">&vellip;</span> and choose Create Mock app.
